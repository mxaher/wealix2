    ...
    <LegalPageLayout title="Terms of Service" effectiveDate="27 March 2026" version="1.0">
      ...
      <LegalSection title="Part Five — AI Features and Financial Data">
        <LegalSubsection title="11. AI Financial Advisor">
          <p>11.1 Nature of AI Advice: The AI Financial Advisor feature provides conversational financial information generated by artificial intelligence through third-party AI processors used by Wealix, including NVIDIA-powered APIs where enabled. These responses are not regulated financial advice and do not constitute recommendations from a licensed financial advisor, investment advisor, or broker.</p>
        ...
        <LegalSubsection title="12. Market Data and Investment Tracking">
          <p>12.1 Market data is sourced from third-party providers such as SAHMK and any other supported quote vendors and may be delayed, approximate, or unavailable for certain markets. Wealix is not responsible for the accuracy or timeliness of third-party market data.</p>
        ...
        <LegalSubsection title="13. Receipt Scanning and OCR">
          <p>13.1 The receipt scanning and OCR feature uses AI and OCR processors selected by Wealix, including NVIDIA-powered APIs and fallback OCR providers when configured, to extract text from receipt images. OCR accuracy is not guaranteed and extracted data (merchant name, amount, date, category) may be inaccurate.</p>
          ...
          <p>13.3 Receipt images and OCR payloads are processed only to complete the requested extraction workflow and are subject to the storage and retention behavior described in the Privacy Policy. You may delete saved receipt-related records from your account.</p>
